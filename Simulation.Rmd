...
In this project we will investigate the exponential distribution in R and compare it with the Central Limit Theorem. The exponential distribution can be simulated in R with rexp(n, lambda) where lambda is the rate parameter. As instructed, both the mean of exponential distribution and the standard deviation are 1/lambda, and we will set lambda = 0.2 for all of the simulations. We will investigate the distribution of averages of 40 exponentials. Note that we will need to do a thousand simulations.

With the simulation, we will attempt to answer the following questions:
